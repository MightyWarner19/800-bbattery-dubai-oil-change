  ...
  return (
    <>
      <div className="pb-12  bg-white-200 ">
        <div
          class="bg-gradient-to-b from-white-300 to-white-500 w-full lg:py-14 py-6"
          id="testimonial"
        >
          <div class="max-w-screen-xl  px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center">
            <div class="flex flex-col w-full mt-16" id="testimoni">
              <div>
                <div class="flex flex-col items-center">
                  <div class="flex items-center mb-4">
                    <span class="block w-10 h-1 bg-yellow-500 mr-2"></span>
                    <h2 class="text-yellow-500 font-semibold text-xl  uppercase">
                      Our Services
                    </h2>
          ...
          <div class="bg-white rounded-sm shadow-lg">
            ...
            <div class="p-6">
              ...
              <a
                ...
                class="text-purple-600 hover:text-yellow-500 flex flex-row underline underline-offset-4 "
              >
                Read More &nbsp;
