...
const Services = () => {
  return (
    ...
    <div className="bg-gradient-to-b from-white-300 to-white-500 w-full lg:py-14 py-6" id="testimonial">
      <div className="max-w-screen-xl  px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center">
        <div className="flex flex-col w-full mt-16" id="testimoni"><div>
          <div className="flex flex-col items-center">
            <div className="flex items-center mb-4">
              <span className="block w-10 h-1 bg-yellow-500 mr-2"></span>
              <h2 className="text-yellow-500 font-semibold text-xl  uppercase">Our Services</h2>
      ...
      <div className="bg-white rounded-sm shadow-lg">
         <Image
                    ...
                    />
        <div className="p-6">
          <h2 className="font-bold mb-2 text-2xl text-purple-800">Onsite Mobile Car Inspection
          </h2>
          ...
          <a href="https://www.800bbattery.com/service/onsite-mobile-car-service" className="text-purple-600 hover:text-yellow-500 flex flex-row underline underline-offset-4 ">Read More &nbsp;<MoveRight className="text-yellow-500" /></a>
        </div>
      ...
      <div className="bg-white rounded-sm shadow-lg">
         <Image
                    ...
                    />
        <div className="p-6">
          <h2 className="font-bold mb-2 text-2xl text-purple-800">Onsite Mobile Car Service
          </h2>
          <p className="text-purple-700 mb-2">Avoid the hassle of waiting at shops or arranging rides with our same day services. With 800 B Battery’s Onsite Mobile Car Services, including car oil changes, expert car care comes to you—at home, work, or anywhere convenient. </p>
          <a href="https://www.800bbattery.com/service/onsite-mobile-car-service" className="text-purple-600 hover:text-yellow-500 flex flex-row underline underline-offset-4 ">Read More &nbsp;<MoveRight className="text-yellow-500" /></a>
        </div>
